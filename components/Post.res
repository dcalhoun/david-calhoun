...
module UnorderedList = {
  @react.component
  let make = (~children) => <ul className="font-serif list-decimal pl-6 md:pl-8"> children </ul>
}

module OrderedList = {
  @react.component
  let make = (~children) => <ol className="font-serif list-decimal pl-6 md:pl-8"> children </ol>
}
