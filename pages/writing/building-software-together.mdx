...
Communicating tone and intent via text is difficult. Using collaborative language can go a long way to unifying a team around the common goal—shipping great software.
